...
class UserData(models.Model):
    ...
    lettura1 = models.CharField(max_length=255, blank=True, null=True)
    lettura2 = models.CharField(max_length=255, blank=True, null=True)
    lettura3 = models.CharField(max_length=255, blank=True, null=True)
